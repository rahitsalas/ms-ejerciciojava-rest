...
public class ServiceTechnicalException extends BaseException {

	private static final long serialVersionUID = 1L;

	private ServiceTechnicalException(Exception exception) {
		super(exception);
	}

	public ServiceTechnicalException(String code, String message, HttpStatus status, String number) {
	...
	public static class Builder {
		...
		public ServiceTechnicalException build() {

			ServiceTechnicalException serviceException = new ServiceTechnicalException(exception);
